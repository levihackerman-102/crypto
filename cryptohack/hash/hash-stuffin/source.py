...
'''
just construct a message with 63 bytes of '\x01', it will be padded with another '\x01' byte
and this collides with 64 '\x01' bytes

otherwise the hash function is also reversible
'''
